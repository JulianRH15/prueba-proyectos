...
public class Event {
	...
	public Event(String title, LocalDate startDate, LocalTime startTime, LocalDate endDate, LocalTime endTime,
	...
	public String toString() {
		return "Event [id=" + id + ", title=" + title + ", startDate=" + startDate + ", startTime=" + startTime
